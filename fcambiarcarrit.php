...
$resul1 = mysqli_query($link,"SELECT cliente, producto, cantidad, npedido, FROM compra"); 
//Creamos  la tabla
echo "<table> \n"; 
//incluimos los nombres de los campos
echo "<tr class='red'><td>Numero Pedido</th><th>Cliente </th><th>Producto </th><th> Cantidad </th></tr> \n"; 
//Incluimos los resultados de la búsqueda

while ($row = mysqli_fetch_row($resul1)){ 
       echo "<tr><td>$row[3]</td><td>$row[0]</td><td>$row[1]</td><td>$row[2]</td></tr>\n"; 
} 
echo "</table> \n"; 
?> 


			<h2>Modificar el carrito</h2>



			<form name="form" method="post" action="./utils/modificarcarrito.php">
                            <div class="fild">
					<label for="id" class="id">Cambiar por número de pedido:</label>
					<input
						name="npedido"
						type="number"
						id="npedido"
				...
				<div class="fild">
					<label for="name" class="name">Cliente:</label>
					<input
						name="cliente"
						type="text"
						id="cliente"
				...
				<div class="fild">
					<label for="surname" class="surname">Producto:</label>
					<input
						name="producto"
						type="text"
						id="producto"
				...
				<div class="fild">
					<label for="email" class="email">Cantidad:</label>
					<input
						name="cantidad"
						type="text"
						id="cantidad"
