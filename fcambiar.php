...
?> 
			...
			<form name="form" method="post" action="./utils/modificar.php">
                            <div class="fild">
					<label for="id" class="id">ID del cliente que quieres modificar:</label>
					<input
						name="id"
						type="text"
						id="id"
				...
				<div class="fild checkbox">
					<label for="adming" class="admin">¿Admin?</label>
					<input
						name="admin"
						type="checkbox"
						id="admin"
